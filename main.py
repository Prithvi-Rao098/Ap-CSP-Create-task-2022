...
INVADER1 = pygame.transform.scale(
    pygame.image.load(os.path.join("invader.png")), (55, 50))
INVADER2 = pygame.transform.scale(
    pygame.image.load(os.path.join("invader.png")), (75, 60))
...
class MainCharacter(Character):
    ...
    def healthbar(self, window):
        pygame.draw.rect(window, (255, 0, 0), (self.x, self.y +
                         self.MC_img.get_height() + 10, self.MC_img.get_width(), 10))
        pygame.draw.rect(window, (0, 255, 0), (self.x, self.y + self.MC_img.get_height() +
                         10, self.MC_img.get_width() * (self.health/self.max_health), 10))
